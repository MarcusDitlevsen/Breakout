    ...
    public class Wedge : ISquadron {
        ...
        public void CreateEnemies(List<Image> enemyStride,
            ...
            Enemies.AddEntity(new Enemy(
                new DynamicShape(new Vec2F(0.25f + 1.0f * 0.1f, 0.9f), new Vec2F(0.1f, 0.1f)),
            ...
            Enemies.AddEntity(new Enemy(
                ...
                new ImageStride(80, enemyStride), new ImageStride(80, alternativeEnemyStride)));
            Enemies.AddEntity(new Enemy(
                new DynamicShape(new Vec2F(0.25f + 3.0f * 0.1f, 0.7f), new Vec2F(0.1f, 0.1f)),
                new ImageStride(80, enemyStride), new ImageStride(80, alternativeEnemyStride)));
            Enemies.AddEntity(new Enemy(
                new DynamicShape(new Vec2F(0.25f + 4.0f * 0.1f, 0.8f), new Vec2F(0.1f, 0.1f)),
                new ImageStride(80, enemyStride), new ImageStride(80, alternativeEnemyStride)));
            Enemies.AddEntity(new Enemy(
                new DynamicShape(new Vec2F(0.25f + 5.0f * 0.1f, 0.9f), new Vec2F(0.1f, 0.1f)),
                new ImageStride(80, enemyStride), new ImageStride(80, alternativeEnemyStride)));
            }
    }
}